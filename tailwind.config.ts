  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'neumorphic-inset-sm': 'inset 4px 4px 8px #c7c7c7, inset -4px -4px 8px #ffffff',
        'neumorphic-inset-sm-dark': 'inset 4px 4px 8px #1a1a1a, inset -4px -4px 8px #2c2c2c',
        ...
        'neumorphic-inset-dark': 'inset 8px 8px 16px #1a1a1a, inset -8px -8px 16px #2c2c2c',
      },
      borderRadius: {
        lg: 'var(--radius)',
